...
import UpcomingWebinarsHomeSection from "./UpcomingWebinarsHomeSection";
...
export default function HomePageClient({ initialWebinars }: { initialWebinars: PublicWebinarRow[] }) {
      ...
      <div className="mx-auto w-full max-w-5xl px-4 sm:px-6">
        ...
        <div className="space-y-6 text-center md:text-left">
          ...
          <div className="space-y-3 max-w-xl mx-auto md:mx-0">
            ...
            <UpcomingWebinarsHomeSection initialWebinars={initialWebinars} />
